  ...
  <main id="main">
    ...
    <section id="schedule">
        <div class="container" data-aos="fade-up">
          ...
          <ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="100">
            <li class="nav-item">
              <button onclick="moveAll()" class="nav-link active" role="tab" style="width:250px;">박스오피스</button>
            ...
            <li class="nav-item">
              <button onclick="moveCs()" class="nav-link" role="tab" style="width:250px;">상영예정작</button>
              <script type="text/javascript">
              	function moveCs(){
              		location.href = "csMv";
              	}
    ...
    <section id="speakers">
      <div class="container" data-aos="fade-up"></div>
        ...
        <br/>
        <div class="row"> <!-- 여기서부터 상영예정작 가져오는 곳 -->
        		...
        		<a href="mvInfo?mv_Name=${list.mv_Name}"><img src="resources/assets/poster/${list.mv_PosterName}" class="img-fluid" width="490" height="500"></a>
             	<div class="details">
                	<h3><a href="mvInfo?mv_Name=${list.mv_Name}">${list.mv_Name}</a></h3>
		     		<p>개봉일 <span id="mv_Openday" style="color: blue; font-size:15px; font-weight: bold;">${list.mv_Openday}</span>
